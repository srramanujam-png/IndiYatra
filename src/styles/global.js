...
export const globalStyles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Font size utility */
  body[data-fs="sm"] .fs-body    { font-size: 14px !important; }
  body[data-fs="md"] .fs-body    { font-size: 16px !important; }
  body[data-fs="lg"] .fs-body    { font-size: 18px !important; }
  body[data-fs="sm"] .fs-heading { font-size: 22px !important; }
  body[data-fs="md"] .fs-heading { font-size: 26px !important; }
  body[data-fs="lg"] .fs-heading { font-size: 30px !important; }
  ...
  .header-nav a {
    font-family: 'Alumni Sans', sans-serif; font-size: 18px; font-weight: 700;
  ...
  .header-settings-btn {
    ...
    cursor: pointer; transition: border-color 0.2s, background 0.2s; font-size: 16px; color: #888;
  }
  ...
  .register-btn {
    ...
    padding: 7px 18px; font-family: 'Alumni Sans', sans-serif; font-size: 16px;
  ...
  .breadcrumb {
    ...
    font-size: 13px; color: #999; display: flex; align-items: center; gap: 8px; flex-wrap: wrap;
  }
  ...
  .page-title    { font-family: 'Alumni Sans', sans-serif; font-size: 38px; font-weight: 800; color: ${HERITAGE}; margin-bottom: 4px; }
  ...
  .settings-drawer-title { font-family: 'Alumni Sans', sans-serif; font-size: 22px; font-weight: 800; color: ${HERITAGE}; }
  .settings-close {
  ...
  /* Misc shared */
  .loading { text-align: center; padding: 60px 1rem; font-family: 'Alumni Sans', sans-serif; font-size: 22px; color: ${SAFFRON}; }
  .empty   { text-align: center; padding: 40px 1rem; font-size: 15px; color: #999; }
  .footer  { text-align: center; padding: 24px 1rem; font-size: 13px; color: #999; border-top: 1px solid #eee; }
  ...
  @media (max-width: 480px) {
    ...
    .register-btn { padding: 6px 14px; font-size: 14px; }
    .page-title { font-size: 26px; }
    .breadcrumb { padding: 10px 1rem 0; font-size: 12px; }
  }
`;
